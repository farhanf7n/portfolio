...
import type { Song } from '@/app/api/lastfm/latest/get-latest-songs';
  ...
  return (
    ...
    >
      ...
      <div className="flex min-w-0 flex-col justify-center">
        <small className="text-2xs flex items-center font-semibold uppercase leading-tight tracking-widest text-rose-500 dark:text-rose-400">
          <svg
