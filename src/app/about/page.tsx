        ...
        <section className="mb-8 flex w-full flex-col pb-4 md:mb-4 lg:mb-12 lg:flex-row">
          <div className="w-full lg:mx-auto">
            <div className="relative h-40 w-full lg:h-48">
              <div className="absolute inset-0 left-1/2 mx-auto w-full max-w-xl -translate-x-1/2 rounded-2xl bg-neutral-100 bg-[url('/cover1.jpg')] bg-cover bg-center lg:ml-0">
